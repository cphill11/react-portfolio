...
function Portfolio() {
  return (
    <section className="my-5">
      ...
      <div className="my-2">
        <p>
         Placeholder for links to repos.
        </p>
      </div>
    </section>
  );
...
// For each project featured in portfolio, you should include the following:
...
// 1 Interactive Front-End Project (M8 Group Project)   
        ...
        // Not deployed to heroku.. deploy (?)
        // comics-and-cocktails.jpg
